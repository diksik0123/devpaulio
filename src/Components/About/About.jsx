    ...
    <section id='about' className="fade-up">
        <div className="container">
          ...
          <div className={`row pt-3 ${styles['about-container']}`}>
            ...
            <br /><br />
            Currently, I'm a Front End Developer at <span style={styles.span}>empleyado Incorporated</span>, specializing in user interface and responsive development. I mainly contribute to creating UI modules and integrating APIs.
            </p>
          </div>
        </div>
    </section>
